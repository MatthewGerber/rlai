...
def test_run():
    ...
    run_args_list = [
        ...
        '--T 30 --n-runs 500 --environment rl.environments.mdp.Gridworld --id example_4_1 --agent rl.agents.mdp.Stochastic --gamma 1 --mdp-solver rl.dynamic_programming.value_iteration.iterate_value_v_pi --theta 0.001 --update-in-place --evaluation-iterations-per-improvement 1'
    ]
