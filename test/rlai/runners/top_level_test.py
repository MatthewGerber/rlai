...
def test_help():
    ...
    top_level.run(shlex.split('help rlai.core.agents.ActionValueMdpAgent'))
    top_level.run(shlex.split('help rlai.core.agents.ParameterizedMdpAgent'))
    top_level.run(shlex.split('help rlai.core.agents.StochasticMdpAgentXXXX'))
